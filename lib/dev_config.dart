...
const Duration kFollowMeCameraRefresh = Duration(seconds: 8);
const double kFollowMeCameraRefreshDistanceMeters = 250.0;
...
const Duration kFollowMeAnimationDuration = Duration(milliseconds: 1200);
const Duration kFollowMeMinAnimationInterval = Duration(milliseconds: 600);
const double kMinSpeedForRotationMps =
    1.0; // Minimum speed (m/s) to apply rotation
const double kFollowMeJitterFloorMeters =
    4.0; // Ignore smaller GPS wobble while following
const double kFollowMeSnapDistanceMeters =
    140.0; // Snap only to very large position jumps
const double kFollowMeSlowAlpha = 0.18; // More smoothing at walking/idle speeds
const double kFollowMeCityDrivingAlpha = 0.36;
const double kFollowMeFastDrivingAlpha = 0.52;
const double kFollowMeHeadingAlpha = 0.18;
